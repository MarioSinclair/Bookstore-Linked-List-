...
Description:
Create a BookNode Record(3) - contains bookid, name, author, price and a pointer to the next book Node.

A Book List implementing the following operations: (9)

BookNode * CreateBookList(), - creates a book node that points to null. Returns a BookNode pointer.

BookNode * AddBook(BookNode * head) - takes in the pointer to the head of a book list, adds a new book to the head of the list. Prints the entire list with the new book added. Returns new head of the book list.
